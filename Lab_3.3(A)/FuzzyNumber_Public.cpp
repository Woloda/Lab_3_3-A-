...
FuzzyNumber_Public::FuzzyNumber_Public() :FuzzyNumber(0, 0, 0) {} //конструктор за умовчанням(без параметрів)

FuzzyNumber_Public::FuzzyNumber_Public(double value_x, double value_l, double value_r) : FuzzyNumber(value_x, value_l, value_r) {}   //конструктор ініціалізації

FuzzyNumber_Public::FuzzyNumber_Public(FuzzyNumber_Public& obj, int) : FuzzyNumber(obj.get_x(), obj.get_l(), obj.get_r()) {}  //конструктор копіювання
